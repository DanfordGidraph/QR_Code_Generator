...
const Footer = () => {
    return (
        <MDBFooter style={{position:'absolute', bottom:0, width:'85vw', alignSelf: 'center'}} color="#39065a" className="text-center font-small darken-2">
            <div className="pb-4">
            ...
            <p className="footer-copyright mb-0 py-3 text-center" style={{background:"#39065a"}}>
